...
export default function Search() {
  ...
  const [searchMovies, { data, loading, error }] = useLazyQuery(SEARCHING);

  useEffect(() => {
    const urlParams = new URLSearchParams(location.search);
    const vaiSimi = urlParams.toString();
  }, [location.search]);
  ...
  const handleSearch = () => {
    ...
    urlParams.set("director", searchParams.director);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="col-span-1 lg:col-span-3">
          <h1 className="text-3xl font-semibold border-b-2 pb-2 mb-4 text-zinc-400">
            Found: {data ? data.filterMovies.length : 0} results
          </h1>
